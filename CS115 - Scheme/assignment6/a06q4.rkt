...
;; Purpose: produces sublist of first given list (lst2) with the same length
...
;; Purpose: produces a boolean indicating whether the second given list (lst2)
;; contains all elements in the first given list (lst1) and in the same order
