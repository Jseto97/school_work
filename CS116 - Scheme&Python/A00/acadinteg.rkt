...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname acadinteg) (read-case-sensitive #t) (teachpacks ((lib "compound.rkt.txt" "installed-teachpacks"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "compound.rkt.txt" "installed-teachpacks")))))
Academic Integrity Acknowledgement Form
CS 116 Spring 2012

This form is adapted from forms provided by the Office of Academic Integrity 
as an educational tool to help students maintain high standards of academic 
integrity (AI) in their work. The original versions are available online at:
http://www.adm.uwaterloo.ca/infoacad/AI_Acknowledgement_Forms/index.html.
...
from the course professor(s), tutor(s) or IA(s), TA(s), academic
advisor(s), or the Undergraduate Associate Dean.

For information on categories of offences and types of penalties, students should 
